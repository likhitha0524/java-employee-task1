...
public class EmployeeService {
    ...
    public static void main( String[] args )
    {
        ...
        List<Employee> employees=repository.getEmployeesList();
...
//        List employee name and duration of their service in months and days
        System.out.println("Employee with duration of service");
        System.out.println();
        employees.forEach((a)->{
...
//        Find out departments without employees
